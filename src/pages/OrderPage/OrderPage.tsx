...
import {format_date_transport} from "../../utils/utils";
        ...
        <div className="order-page-wrapper">
            ...
            <div className="order-products-wrapper">
                ...
                <div className="order-info-container">
                    ...
                    {[2, 3, 4].includes(order.status) && <span>Дата провоза через таможню: {format_date_transport(order.date_transport)}</span> }
